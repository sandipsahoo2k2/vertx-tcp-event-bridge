...
var BridgeEvent = require('vertx-tcp-eventbus-bridge-js/bridge_event');
...
TcpEventBusBridge.create = function() {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    ...
    return utils.convReturnVertxGen(TcpEventBusBridge, JTcpEventBusBridge["create(io.vertx.core.Vertx,io.vertx.ext.bridge.BridgeOptions,io.vertx.core.net.NetServerOptions,io.vertx.core.Handler)"](__args[0]._jdel, __args[1] != null ? new BridgeOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null, __args[2] != null ? new NetServerOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null, function(jVal) {
    __args[3](utils.convReturnVertxGen(BridgeEvent, jVal));
  }));
  } else throw new TypeError('function invoked with invalid arguments');
};
